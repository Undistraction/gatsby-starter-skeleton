...
const appliesToNode = curry((value, descriptor) => {
  console.log(`VAL`, value.frontmatter)
  // console.log(`DES`, descriptor)
  // console.log(`PRED`, prop(`predicate`)(descriptor))
  // console.log(`RES`, prop(`predicate`)(descriptor)(value))
  console.log(`>>`, value.internal.type)
...
const attachFields = (node, createNodeField, descriptors, context) => {
  ...
  console.log(`ATTACH FIELDS`, descriptorsForNode)
